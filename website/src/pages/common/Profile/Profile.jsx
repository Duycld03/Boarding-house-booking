            ...
            <div className="lg:col-span-3">
              ...
              >
                <div className="flex flex-col items-center">
                  ...
                  <Title
                    level={3}
                    className={`m-0 text-center ${darkMode ? "text-gray-100" : "text-gray-800"
                      }`}
                  >
                    @{username}
                  </Title>
                  ...
                  {isOwner && (
                    <div
                      className={`mt-4 p-4 rounded-lg text-center ${darkMode ? "bg-gray-800" : "bg-gray-50"
                        }`}
                    >
                      <Text
                        strong
                      ...
                      <div
                        className={`text-xl font-bold mt-2 ${darkMode ? "text-green-400" : "text-green-600"
                          }`}
                      >
            ...
            <div className="lg:col-span-9">
              ...
              >
                ...
                <div className="mb-8">
                  <Title
                    level={4}
                    className={`mb-6 ${darkMode ? "text-gray-200" : "text-gray-700"
                      }`}
                  >
                    Account Information
                  </Title>
