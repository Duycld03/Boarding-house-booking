...
export default function CreateRenewalRequest() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            showError(error?.response?.data?.message || t("createRenewalRequest.errorMessage"));
        } finally {
            setLoading(false);
        }
    };
        ...
        <ScreenContainer withPadding={false}>
            ...
            <ScrollView className="px-4">
                ...
                <View className="mb-5">
                    ...
                    <View className={`p-4 rounded-lg mb-4 ${isDarkMode ? "bg-gray-800" : "bg-gray-100"}`}>
                        {/* Boarding House Name */}
                ...
                <View className="mb-5">
                    <Text
                        className={`text-base font-semibold mb-2 ${isDarkMode ? "text-white" : "text-gray-700"}`}
                    >
                ...
                <View className="mb-5">
                    <Text
                        className={`text-base font-semibold mb-2 ${isDarkMode ? "text-white" : "text-gray-700"}`}
                    >
                        {t("createRenewalRequest.renewalDuration")} <Text style={{ color: "red" }}>*</Text>
                    </Text>
                    ...
                    <View className="flex-row space-x-2">
                        ...
                        <View className="w-1/3">
                            ...
                            >
                                <Text className={isDarkMode ? "text-white" : "text-black"}>
                                    {timeUnit === "month" ? t("createRenewalRequest.months") : t("createRenewalRequest.years")}
                                </Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                ...
                <View className="mb-5">
                    ...
                    <TextInput
                        ...
                        className={`p-3 border rounded-lg ${isDarkMode
